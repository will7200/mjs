...
type QueryRequest struct {
	Query *Job `protobuf:"bytes,1,opt,name=query" json:"query,omitempty"`
}

func (m *QueryRequest) Reset()                    { *m = QueryRequest{} }
func (*QueryRequest) ProtoMessage()               {}
func (*QueryRequest) Descriptor() ([]byte, []int) { return fileDescriptorApischeduler, []int{17} }

func (m *QueryRequest) GetQuery() *Job {
	if m != nil {
		return m.Query
	}
	return nil
...
func (*QueryReply) Descriptor() ([]byte, []int) { return fileDescriptorApischeduler, []int{18} }

func (m *QueryReply) GetJobs() []*Job {
	if m != nil {
		return m.Jobs
	}
	return nil
...
func (c *aPISchedulerClient) Query(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (*QueryReply, error) {
	out := new(QueryReply)
	err := grpc.Invoke(ctx, "/pb.APIScheduler/Query", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _APIScheduler_Query_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APISchedulerServer).Query(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.APIScheduler/Query",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APISchedulerServer).Query(ctx, req.(*QueryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _APIScheduler_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Query",
			Handler:    _APIScheduler_Query_Handler,
		},
	},
...
func (m *QueryRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Query != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintApischeduler(dAtA, i, uint64(m.Query.Size()))
...
func (this *QueryRequest) String() string {
	...
	s := strings.Join([]string{`&QueryRequest{`,
		`Query:` + strings.Replace(fmt.Sprintf("%v", this.Query), "Job", "Job", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorApischeduler = []byte{
	...
	,
}
